...
using PR_API_ASP.Models;
using System;
/*Esto hace parte de los cors*/
using PR_API_ASP.Controllers;
using Microsoft.AspNetCore.Cors;

namespace PR_API_ASP.Controllers
{   
    ...
    public class ProductoController : ControllerBase
    {
        ...
        public ProductoController(BDAPIContext context)
        {
            _dbcontext = context;
        }
